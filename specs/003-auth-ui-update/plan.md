...
│   │       ├── SplitScreenAuth.tsx    # Main split-screen container
│   │       ├── LeftPanel.tsx          # Left panel with brand content
│   │       ├── RightPanel.tsx         # Right panel with form content
│   │       ├── LoginForm.tsx          # Updated login form styling
│   │       └── RegisterForm.tsx       # Updated register form styling
│   ├── pages/
│   │   └── (auth)/
│   │       ├── login/
│   │       │   └── page.tsx           # Updated login page using new components
│   │       └── register/
│   │           └── page.tsx           # Updated register page using new components
│   └── services/
└── tests/
```

**Structure Decision**: Selected Option 2 (Web application) as this feature involves both frontend UI components and integration with existing backend authentication services. The new components will be placed in the frontend/src/components/auth directory, with updated page files in the auth routes.
